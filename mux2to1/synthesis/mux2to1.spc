...
.subckt mux2to1 vdd gnd in0 in1 out s 

XSFILL1040x100 vdd gnd FILL
XSFILL1520x100 vdd gnd FILL
X_4_ vdd _1_ gnd in1 s NAND2X1
XSFILL1360x100 vdd gnd FILL
XSFILL1680x100 vdd gnd FILL
XSFILL3120x100 vdd gnd FILL
X_6_ vdd gnd _2_ out BUFX2
X_3_ in0 _0_ vdd gnd INVX1
XSFILL3440x100 vdd gnd FILL
XSFILL3280x100 vdd gnd FILL
X_5_ gnd vdd s _0_ _2_ _1_ OAI21X1
XSFILL2000x100 vdd gnd FILL
XSFILL2960x100 vdd gnd FILL
XSFILL1840x100 vdd gnd FILL
XSFILL2160x100 vdd gnd FILL
XSFILL1200x100 vdd gnd FILL
