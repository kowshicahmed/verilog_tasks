...
.subckt control_unit vdd gnd adrs_ctrl clock decoder_en flag imm_en
+ inst_wr mem_rd mem_wr opcode[0] opcode[1] opcode[2] opcode[3] pc_op[0]
+ pc_op[1] rD_wr reg_en reset 

X_60_ vdd gnd _24_ mem_wr BUFX2
X_57_ vdd gnd gnd imm_en BUFX2
XSFILL8080x2100 vdd gnd FILL
X_54_ vdd gnd reset _21_ _4_ AND2X2
XSFILL7760x4100 vdd gnd FILL
X_51_ cState[1] _20_ vdd gnd INVX1
X_48_ gnd vdd cState[0] cState[2] _18_ reset OAI21X1
X_45_ gnd vdd _14_ _11_ opcode[2] _15_ 
+ _16_
+ OAI22X1
XSFILL7760x2100 vdd gnd FILL
XSFILL7600x100 vdd gnd FILL
X_42_ opcode[3] _13_ vdd gnd INVX1
X_39_ vdd _11_ gnd opcode[0] _10_ NAND2X1
X_36_ vdd _8_ gnd _9_ _6_ NOR2X1
XSFILL3120x4100 vdd gnd FILL
X_33_ _6_ opcode[2] vdd gnd opcode[3] OR2X2
X_68_ vdd _2_ gnd _22_ clock DFFPOSX1
X_30_ vdd _25_[1] gnd cState[0] _5_ NAND2X1
X_65_ vdd _0_ gnd cState[0] clock DFFPOSX1
XSFILL2160x2100 vdd gnd FILL
X_62_ vdd gnd _25_[1] pc_op[1] BUFX2
X_59_ vdd gnd _23_ mem_rd BUFX2
XSFILL7760x100 vdd gnd FILL
X_56_ vdd gnd _21_ decoder_en BUFX2
XSFILL3120x100 vdd gnd FILL
X_53_ vdd _20_ gnd _3_ _0_ NOR2X1
X_50_ cState[2] _19_ vdd gnd INVX1
XSFILL7600x4100 vdd gnd FILL
X_47_ vdd _16_ gnd _26_ _17_ NOR2X1
XSFILL3440x4100 vdd gnd FILL
X_44_ vdd _15_ gnd opcode[1] opcode[0] NAND2X1
X_41_ vdd gnd _12_ cState[1] _23_ AND2X2
XSFILL7600x2100 vdd gnd FILL
X_38_ opcode[1] _10_ vdd gnd INVX1
XSFILL2480x2100 vdd gnd FILL
XSFILL7440x100 vdd gnd FILL
X_35_ vdd _8_ gnd opcode[1] _7_ NAND2X1
X_32_ vdd _0_ gnd _1_ _5_ NOR2X1
XSFILL3280x100 vdd gnd FILL
X_29_ _22_ _5_ vdd gnd INVX1
X_67_ vdd _3_ gnd cState[2] clock DFFPOSX1
XSFILL2800x100 vdd gnd FILL
XSFILL7280x100 vdd gnd FILL
X_64_ vdd gnd _27_ reg_en BUFX2
X_61_ vdd gnd _25_[0] pc_op[0] BUFX2
XSFILL7920x4100 vdd gnd FILL
X_58_ vdd gnd _22_ inst_wr BUFX2
X_55_ vdd gnd gnd adrs_ctrl BUFX2
X_52_ gnd vdd _19_ _20_ _27_ _16_ AOI21X1
XSFILL7920x2100 vdd gnd FILL
XFILL9200x100 vdd gnd FILL
X_49_ _18_ _2_ vdd gnd INVX1
X_46_ gnd vdd _6_ _8_ _17_ cState[2] OAI21X1
XSFILL2960x100 vdd gnd FILL
X_43_ vdd _14_ gnd opcode[2] _13_ NAND2X1
XSFILL2640x2100 vdd gnd FILL
X_40_ vdd _11_ gnd _12_ _6_ NOR2X1
X_37_ vdd gnd _9_ cState[2] _24_ AND2X2
XSFILL3280x4100 vdd gnd FILL
X_34_ opcode[0] _7_ vdd gnd INVX1
XSFILL2320x2100 vdd gnd FILL
X_69_ vdd _1_ gnd _21_ clock DFFPOSX1
X_31_ reset _0_ vdd gnd INVX1
X_28_ vdd cState[0] gnd _25_[0] _22_ NOR2X1
X_66_ vdd _4_ gnd cState[1] clock DFFPOSX1
XSFILL8080x4100 vdd gnd FILL
XFILL9200x2100 vdd gnd FILL
X_63_ vdd gnd _26_ rD_wr BUFX2
XSFILL2960x4100 vdd gnd FILL
